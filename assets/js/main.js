...
function deactivateReceiptsCover() {
  const coverInputs = document
    .querySelector(".receipt-data-cover-fieldset")
...
document
  .getElementById("rent-value")
  .addEventListener("input", formatMoneyValue);
document
  .getElementById("receipts-cover-checkbox")
  .addEventListener("change", deactivateReceiptsCover);
